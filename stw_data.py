...
#        CITY ENEMIES
# ========================
{'name': const.Enemies.BANDIT,        'hp': 80,  'weapon': [const.Weapons.KNIFE, const.Weapons.BAT],                              'bounty': 30, 'type': 'normal'},
{'name': const.Enemies.GOON,          'hp': 100, 'weapon': [const.Weapons.CHILI_POWDER, const.Weapons.BAT, const.Weapons.PISTOL],             'bounty': 40, 'type': 'normal'},
{'name': const.Enemies.PIMP,          'hp': 120, 'weapon': [const.Weapons.PEPPER_SPRAY, const.Weapons.BRASS_KNUCKLES, const.Weapons.REVOLVER],'bounty': 60, 'type': 'normal'},
{'name': const.Enemies.HOBO,          'hp': 80,  'weapon': [const.Weapons.BROKEN_BOTTLE, const.Weapons.KNIFE, const.Weapons.POCKET_SAND],     'bounty': 25, 'type': 'normal'},
{'name': const.Enemies.SERIAL_KILLER, 'hp': 120, 'weapon': [const.Weapons.KNIFE, const.Weapons.MACHETE],                          'bounty': 65, 'type': 'normal'},

# ========================
#       FOREST ENEMIES
# ========================
{'name': const.Enemies.HIKER,            'hp': 80,  'weapon': [const.Weapons.HATCHET, const.Weapons.KNIFE, const.Weapons.BEAR_SPRAY],       'bounty': 30, 'type': 'normal'},
{'name': const.Enemies.HUNTER,           'hp': 100, 'weapon': [const.Weapons.KNIFE, const.Weapons.RIFLE, const.Weapons.BEAR_SPRAY],         'bounty': 50, 'type': 'normal'},
{'name': const.Enemies.POACHER,          'hp': 120, 'weapon': [const.Weapons.CROSSBOW, const.Weapons.MACHETE, const.Weapons.BEAR_SPRAY],    'bounty': 60, 'type': 'normal'},
{'name': const.Enemies.DISGRACED_EXILE,  'hp': 100, 'weapon': [const.Weapons.HATCHET, const.Weapons.SHOVEL],                    'bounty': 45, 'type': 'normal'},

# ========================
#        CAVE ENEMIES
# ========================
{'name': const.Enemies.MINER,                 'hp': 80,  'weapon': [const.Weapons.PICKAXE, const.Weapons.KNIFE],                'bounty': 35, 'type': 'normal'},
{'name': const.Enemies.SPELUNKER,             'hp': 100, 'weapon': [const.Weapons.PICKAXE, const.Weapons.KNIFE],                'bounty': 40, 'type': 'normal'},
{'name': const.Enemies.MOLE_PERSON,           'hp': 120, 'weapon': [const.Weapons.CLAWS, const.Weapons.PICKAXE],                'bounty': 55, 'type': 'normal'},
{'name': const.Enemies.HUMANOID_CAVE_CREATURE,'hp': 120, 'weapon': [const.Weapons.CLAWS, const.Weapons.SLEDGEHAMMER],           'bounty': 65, 'type': 'normal'},

# ========================
#        SWAMP ENEMIES
# ========================
{'name': const.Enemies.HAND_FISHERMAN,  'hp': 80,  'weapon': [const.Weapons.HATCHET, const.Weapons.KNIFE],                      'bounty': 30, 'type': 'normal'},
{'name': const.Enemies.BAYOU_MAN,       'hp': 100, 'weapon': [const.Weapons.MACHETE, const.Weapons.SHOTGUN],                    'bounty': 45, 'type': 'normal'},
{'name': const.Enemies.VOODOO_PRIESTESS,'hp': 120, 'weapon': [const.Weapons.VOODOO_STAFF, const.Weapons.KNIFE, const.Weapons.CHILI_POWDER], 'bounty': 70, 'type': 'normal'},
{'name': const.Enemies.SKIN_COLLECTOR,  'hp': 110, 'weapon': [const.Weapons.MACHETE, const.Weapons.CHAINSAW],                   'bounty': 75, 'type': 'normal'},
...
Weapons = [
    ...
    # --- Tier 1 ---
    {'name': const.Weapons.KNIFE,          'damage': 16, 'uses': 8, 'accuracy': 0.88, 'spread': 4, const.Events.CRIT: 0.22,
     'cost': 25,  'sell_value': 12, 'type': 'melee'},

    {'name': const.Weapons.BROKEN_BOTTLE,  'damage': 14, 'uses': 6, 'accuracy': 0.82, 'spread': 5, const.Events.CRIT: 0.20,
     'cost': 20,  'sell_value': 8, 'type': 'melee'},

    {'name': const.Weapons.HATCHET,        'damage': 18, 'uses': 8, 'accuracy': 0.82, 'spread': 5, const.Events.CRIT: 0.16,
     'cost': 30,  'sell_value': 15, 'type': 'melee'},

    # --- Tier 2 ---
    {'name': const.Weapons.BAT,            'damage': 20, 'uses': 9, 'accuracy': 0.80, 'spread': 6, const.Events.CRIT: 0.14,
    ...
    {'name': const.Weapons.BRASS_KNUCKLES, 'damage': 22, 'uses': 9, 'accuracy': 0.90, 'spread': 4, const.Events.CRIT: 0.25,
    ...
    {'name': const.Weapons.MACHETE,        'damage': 26, 'uses': 7, 'accuracy': 0.80, 'spread': 6, const.Events.CRIT: 0.18,
     'cost': 60,  'sell_value': 30, 'type': 'melee'},

    {'name': const.Weapons.AXE,            'damage': 30, 'uses': 6, 'accuracy': 0.76, 'spread': 8, const.Events.CRIT: 0.15,
     'cost': 65,  'sell_value': 32, 'type': 'melee'},

    {'name': const.Weapons.FIRE_AXE,       'damage': 32, 'uses': 6, 'accuracy': 0.75, 'spread': 8, const.Events.CRIT: 0.15,
     'cost': 70,  'sell_value': 35, 'type': 'melee'},

    {'name': const.Weapons.CROSSBOW,       'damage': 34, 'uses': 5, 'accuracy': 0.90, 'spread': 3, const.Events.CRIT: 0.30,
     'cost': 80,  'sell_value': 40, 'type': 'projectile'},

    {'name': const.Weapons.HARPOON,        'damage': 34, 'uses': 6, 'accuracy': 0.78, 'spread': 6, const.Events.CRIT: 0.22,
     'cost': 85,  'sell_value': 42, 'type': 'projectile'},

    # --- Tier 4 Guns ---
    {'name': const.Weapons.PISTOL,         'damage': 30, 'uses': 6, 'accuracy': 0.82, 'spread': 4, const.Events.CRIT: 0.18,
     'cost': 70,  'sell_value': 34, 'type': 'projectile'},

    {'name': const.Weapons.REVOLVER,       'damage': 36, 'uses': 5, 'accuracy': 0.68, 'spread': 6, const.Events.CRIT: 0.25,
     'cost': 78,  'sell_value': 39, 'type': 'projectile'},

    {'name': const.Weapons.RIFLE,          'damage': 38, 'uses': 6, 'accuracy': 0.90, 'spread': 4, const.Events.CRIT: 0.20,
     'cost': 82,  'sell_value': 41, 'type': 'projectile'},

    {'name': const.Weapons.SHOTGUN,        'damage': 40, 'uses': 4, 'accuracy': 0.74, 'spread': 10, const.Events.CRIT: 0.15,
     'cost': 90,  'sell_value': 45, 'type': 'projectile'},

    # --- Tier 5 Heavy ---
    {'name': const.Weapons.CHAINSAW,       'damage': 38, 'uses': 6, 'accuracy': 0.70, 'spread': 10, const.Events.CRIT: 0.20,
     'cost': 95,  'sell_value': 47, 'type': 'melee'},

    {'name': const.Weapons.SLEDGEHAMMER,   'damage': 40, 'uses': 10, 'accuracy': 0.68, 'spread': 8, const.Events.CRIT: 0.22,
     'cost': 100,  'sell_value': 50, 'type': 'melee'},

    # --- Enemy / Monster ---
    {'name': const.Weapons.CLAWS,          'damage': 22, 'uses': -1, 'accuracy': 0.86, 'spread': 4, const.Events.CRIT: 0.18,
     'cost': 0,  'sell_value': 0, 'type': 'special'},

    {'name': const.Weapons.VOODOO_STAFF,   'damage': 28, 'uses': -1, 'accuracy': 0.76, 'spread': 7, const.Events.CRIT: 0.22,
     'cost': 0,  'sell_value': 0, 'type': 'special'},
]
