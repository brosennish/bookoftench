...
Areas = [
    {'name': CITY,
     ...
     'actions_menu': {'pages': [ActionMenuDefaults.page_one, [*ActionMenuDefaults.page_two, BANK, CASINO, COFFEE_SHOP, HOSPITAL]]},
    ...
    {'name': CAVE,
     ...
     'actions_menu': {'pages': [ActionMenuDefaults.page_one, [*ActionMenuDefaults.page_two, LAB, OCCULTIST]]}},
    {'name': SWAMP,
