...
Enemies = [
    ...
    # ========================
    # --- new ---
    {'name': CARD_JOCKEY, 'trait': '', 'hp': 85, 'weapons': [w.SWITCHBLADE, w.POOL_CUE, w.PEPPER_SPRAY],
     'bounty': 160, 'coins': 85, 'type': NORMAL, 'flee': 1, 'strength': 0.85, 'acc': 1.05, 'areas': [CITY]},
    {'name': CLONE, 'trait': '', 'hp': 100, 'weapons': [w.POCKET_KNIFE, w.CANE, w.CHILI_POWDER],
     'bounty': 175, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [CITY]},
    {'name': CLOWN, 'trait': '', 'hp': 100, 'weapons': [w.BROKEN_BOTTLE, w.MEAT_CLEAVER, w.RUBBER_CHICKEN],
     'bounty': 155, 'coins': 25, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [CITY]},
    {'name': FROGGER, 'trait': '', 'hp': 100, 'weapons': [w.FROG_GIG, w.PILLOW, w.PISTOL],
     'bounty': 160, 'coins': 40, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [CITY]},
    {'name': INFLUENCER, 'trait': '', 'hp': 75, 'weapons': [w.POCKET_KNIFE, w.SELFIE_STICK, w.PEPPER_SPRAY],
     'bounty': 135, 'coins': 65, 'type': NORMAL, 'flee': 1, 'strength': 0.75, 'acc': 0.75, 'areas': [CITY]},
    {'name': LIFE_COACH, 'trait': '', 'hp': 90, 'weapons': [w.KNIFE, w.BASEBALL_BAT, w.FIRE_AXE],
     'bounty': 150, 'coins': 40, 'type': NORMAL, 'flee': 1, 'strength': 1.05, 'acc': 1, 'areas': [CITY]},
    {'name': MAGICIAN, 'trait': '', 'hp': 85, 'weapons': [w.SWITCHBLADE, w.SUITCASE, w.PISTOL],
     'bounty': 150, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': .9, 'acc': 1.05, 'areas': [CITY]},
    {'name': MASCOT, 'trait': '', 'hp': 100, 'weapons': [w.T_SHIRT_CANNON, w.FOAM_FINGER, w.BROKEN_BOTTLE],
     'bounty': 135, 'coins': 30, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1, 'areas': [CITY]},
    {'name': MIME, 'trait': '', 'hp': 90, 'weapons': [w.SLINGSHOT, w.CANE, w.SUITCASE],
     'bounty': 150, 'coins': 15, 'type': NORMAL, 'flee': 1, 'strength': 0.9, 'acc': 0.9, 'areas': [CITY]},
    {'name': PARTY_ANIMAL, 'trait': '', 'hp': 95, 'weapons': [w.BROKEN_BOTTLE, w.POOL_CUE],
     'bounty': 170, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1, 'areas': [CITY]},
    {'name': SENTIENT_ROBOT, 'trait': '', 'hp': 110, 'weapons': [w.LASER_BEAMS],
     'bounty': 220, 'coins': 0, 'type': NORMAL, 'flee': 1, 'strength': 1.11, 'acc': 1.11, 'areas': [CITY]},
    {'name': SLEEPWALKER, 'trait': '', 'hp': 95, 'weapons': [w.PILLOW, w.SHOTGUN],
     'bounty': 130, 'coins': 20, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 0.75, 'areas': [CITY]},

    # --- original ---
    {'name': BODY_BUILDER, 'trait': '', 'hp': 110, 'weapons': [w.BASEBALL_BAT, w.INJECTION_NEEDLE, w.DUMBBELL],
     'bounty': 195, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1.2, 'acc': 0.9, 'areas': [CITY]},
    {'name': GOON, 'trait': '', 'hp': 105, 'weapons': [w.BASEBALL_BAT, w.SHOTGUN, w.BRASS_KNUCKLES],
     'bounty': 185, 'coins': 40, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1.1, 'areas': [CITY]},
    {'name': HOBO, 'trait': '', 'hp': 85, 'weapons': [w.BROKEN_BOTTLE, w.KNIFE, w.POCKET_SAND, w.BRICK],
     'bounty': 135, 'coins': 0, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [CITY]},
    {'name': PIMP, 'trait': '', 'hp': 95, 'weapons': [w.CANE, w.BRASS_KNUCKLES, w.REVOLVER, w.SWITCHBLADE],
     'bounty': 190, 'coins': 85, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1.1, 'areas': [CITY]},
    {'name': SERIAL_KILLER, 'trait': '', 'hp': 105, 'weapons': [w.BONE_SAW, w.KNIFE, w.MEAT_CLEAVER],
     'bounty': 235, 'coins': 45, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1.1, 'areas': [CITY, FOREST]},
    {'name': THIEF, 'trait': '', 'hp': 90, 'weapons': [w.KNIFE, w.CROWBAR, w.PISTOL],
    ...
    # ========================
    # --- new ---
    {'name': BIRDER, 'trait': '', 'hp': 75, 'weapons': [w.TRIPOD, w.BINOCULARS, w.PEPPER_SPRAY],
     'bounty': 125, 'coins': 30, 'type': NORMAL, 'flee': 1, 'strength': 0.70, 'acc': 0.75, 'areas': [FOREST]},
    {'name': DOOMSDAY_PREPPER, 'trait': '', 'hp': 95, 'weapons': [w.KNIFE, w.PISTOL],
     'bounty': 180, 'coins': 55, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1.13, 'areas': [FOREST]},
    {'name': FERAL_PHILOSOPHER, 'trait': '', 'hp': 85, 'weapons': [w.CANE, w.PISTOL, w.SCYTHE, w.HARDCOVER_BOOK],
     'bounty': 155, 'coins': 0, 'type': NORMAL, 'flee': 1, 'strength': 0.9, 'acc': 1, 'areas': [FOREST]},
    {'name': FORAGER, 'trait': '', 'hp': 90, 'weapons': [w.KNIFE, w.SICKLE, w.BEAR_SPRAY],
     'bounty': 130, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [FOREST]},
    {'name': MUSHROOM_HUNTER, 'trait': '', 'hp': 100, 'weapons': [w.KNIFE, w.SICKLE, w.BEAR_SPRAY],
     'bounty': 145, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [FOREST]},
    {'name': SURVIVALIST, 'trait': '', 'hp': 100, 'weapons': [w.SURVIVAL_KNIFE, w.LONGBOW, w.BRANCH_SPEAR],
     'bounty': 170, 'coins': 20, 'type': NORMAL, 'flee': 1, 'strength': 1.13, 'acc': 1.1, 'areas': [FOREST]},
    {'name': TELEPATHIC_MUTE, 'trait': '', 'hp': 90, 'weapons': [w.SCYTHE, w.SLINGSHOT, w.CHILI_POWDER],
     'bounty': 170, 'coins': 40, 'type': NORMAL, 'flee': 1, 'strength': 0.85, 'acc': 1.05, 'areas': [FOREST]},

    # --- original ---
    {'name': BIGFOOT_IMPERSONATOR, 'trait': '', 'hp': 110, 'weapons': [w.WOODEN_CLUB, w.BRANCH_SPEAR, w.CLAWS, w.BEAR_SPRAY],
     'bounty': 190, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1.14, 'acc': 1, 'areas': [FOREST]},
    {'name': DISGRACED_EXILE, 'trait': '', 'hp': 85, 'weapons': [w.KNIFE, w.HATCHET, w.SHOVEL, w.TROWEL],
     'bounty': 150, 'coins': 25, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [CAVE, FOREST, SWAMP]},
    {'name': HIKER, 'trait': '', 'hp': 90, 'weapons': [w.TREKKING_POLE, w.SURVIVAL_KNIFE, w.BEAR_SPRAY],
     'bounty': 115, 'coins': 30, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [FOREST]},
    {'name': HUNTER, 'trait': '', 'hp': 100, 'weapons': [w.KNIFE, w.RIFLE, w.BEAR_SPRAY, w.LONGBOW],
     'bounty': 175, 'coins': 45, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1.13, 'areas': [FOREST]},
    {'name': PARK_RANGER, 'trait': '', 'hp': 95, 'weapons': [w.FLARE_GUN, w.KNIFE, w.BEAR_SPRAY, w.MACHETE, w.LONGBOW],
     'bounty': 165, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1.12, 'areas': [FOREST]},
    {'name': POACHER, 'trait': '', 'hp': 95, 'weapons': [w.CROSSBOW, w.MACHETE, w.KNIFE, w.COMPOUND_BOW],
    ...
    # ========================
    # --- new ---
    {'name': ARCHAEOLOGIST, 'trait': '', 'hp': 80, 'weapons': [w.FLASHLIGHT, w.CHISEL, w.HARDCOVER_BOOK],
     'bounty': 130, 'coins': 55, 'type': NORMAL, 'flee': 1, 'strength': 0.85, 'acc': 0.85, 'areas': [CAVE]},
    {'name': EXPLORER, 'trait': '', 'hp': 100, 'weapons': [w.BINOCULARS, w.TREKKING_POLE, w.LONGBOW, w.SURVIVAL_KNIFE],
     'bounty': 140, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1.05, 'areas': [CAVE]},
    {'name': FUGITIVE, 'trait': '', 'hp': 95, 'weapons': [w.SHIV, w.INJECTION_NEEDLE, w.PISTOL, w.POCKET_SAND],
     'bounty': 215, 'coins': 20, 'type': NORMAL, 'flee': 1, 'strength': 1.05, 'acc': 1.1, 'areas': [CAVE, FOREST, SWAMP]},
    {'name': PROSPECTOR, 'trait': '', 'hp': 90, 'weapons': [w.FLASHLIGHT, w.PICKAXE, w.CHISEL],
     'bounty': 115, 'coins': 45, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [CAVE]},
    {'name': SURVIVOR, 'trait': '', 'hp': 100, 'weapons': [w.FLARE_GUN, w.SURVIVAL_KNIFE, w.POCKET_SAND],
     'bounty': 145, 'coins': 20, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1.05, 'areas': [CAVE]},

    # --- original ---
    {'name': ANCIENT_MAN, 'trait': '', 'hp': 85, 'weapons': [w.TORCH_CLUB, w.STONE_SPEAR, w.OBSIDIAN_KNIFE],
     'bounty': 150, 'coins': 25, 'type': NORMAL, 'flee': 1, 'strength': 0.85, 'acc': 0.9, 'areas': [CAVE]},
    {'name': HUMANOID_CAVE_CREATURE, 'trait': '', 'hp': 110, 'weapons': [w.CLAWS, w.SCYTHE, w.BONE_CLUB],
     'bounty': 215, 'coins': 0, 'type': NORMAL, 'flee': 1, 'strength': 1.14, 'acc': 1, 'areas': [CAVE]},
    {'name': MINER, 'trait': '', 'hp': 90, 'weapons': [w.FLASHLIGHT, w.KNIFE, w.PICKAXE],
     'bounty': 115, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1.05, 'acc': 1, 'areas': [CAVE]},
    {'name': MOLE_PERSON, 'trait': '', 'hp': 105, 'weapons': [w.CLAWS, w.PICKAXE, w.BONE_CLUB],
     'bounty': 175, 'coins': 55, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1, 'areas': [CAVE]},
    {'name': SPELUNKER, 'trait': '', 'hp': 90, 'weapons': [w.FLASHLIGHT, w.PICKAXE, w.FLARE_GUN],
    ...
    # ========================
    # --- new ---
    {'name': BONE_COLLECTOR, 'trait': '', 'hp': 105, 'weapons': [w.BONE_SAW, w.BONE_CLUB, w.MEAT_CLEAVER],
     'bounty': 215, 'coins': 20, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1, 'areas': [SWAMP]},
    {'name': FORTUNE_TELLER, 'trait': '', 'hp': 80, 'weapons': [w.KNIFE, w.PEPPER_SPRAY, w.PISTOL],
     'bounty': 140, 'coins': 60, 'type': NORMAL, 'flee': 1, 'strength': 0.80, 'acc': 0.9, 'areas': [SWAMP]},
    {'name': GATOR_WRESTLER, 'trait': '', 'hp': 110, 'weapons': [w.FROG_GIG, w.SHOTGUN, w.SURVIVAL_KNIFE],
     'bounty': 195, 'coins': 50, 'type': NORMAL, 'flee': 1, 'strength': 1.14, 'acc': 1, 'areas': [SWAMP]},
    {'name': MOONSHINER, 'trait': '', 'hp': 85, 'weapons': [w.SWITCHBLADE, w.SHOTGUN, w.NAIL_GUN],
     'bounty': 170, 'coins': 70, 'type': NORMAL, 'flee': 1, 'strength': 0.95, 'acc': 1.1, 'areas': [SWAMP]},
    {'name': SMUGGLER, 'trait': '', 'hp': 90, 'weapons': [w.KNIFE, w.INJECTION_NEEDLE, w.POCKET_SAND, w.PISTOL],
     'bounty': 220, 'coins': 100, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1.1, 'areas': [SWAMP]},
    {'name': TRACKER, 'trait': '', 'hp': 90, 'weapons': [w.FLASHLIGHT, w.KNIFE, w.RIFLE],
     'bounty': 170, 'coins': 30, 'type': NORMAL, 'flee': 1, 'strength': 1.05, 'acc': 1.1, 'areas': [SWAMP]},

    # --- original ---
    {'name': BAYOU_MAN, 'trait': '', 'hp': 105, 'weapons': [w.FROG_GIG, w.GAFF_HOOK, w.SHOTGUN],
     'bounty': 185, 'coins': 35, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1.05, 'areas': [SWAMP]},
    {'name': GRAVE_ROBBER, 'trait': '', 'hp': 95, 'weapons': [w.POCKET_KNIFE, w.SHOVEL, w.CROWBAR, w.POCKET_SAND],
     'bounty': 165, 'coins': 40, 'type': NORMAL, 'flee': 1, 'strength': 1, 'acc': 1, 'areas': [SWAMP]},
    {'name': HAND_FISHERMAN, 'trait': '', 'hp': 90, 'weapons': [w.KNIFE, w.FISHING_SPEAR, w.GAFF_HOOK, w.FROG_GIG],
     'bounty': 150, 'coins': 30, 'type': NORMAL, 'flee': 1, 'strength': 1.1, 'acc': 1, 'areas': [SWAMP]},
    {'name': SKIN_COLLECTOR, 'trait': '', 'hp': 105, 'weapons': [w.KNIFE, w.MEAT_CLEAVER, w.CHAINSAW, w.MACHETE],
     'bounty': 220, 'coins': 25, 'type': NORMAL, 'flee': 1, 'strength': 1.05, 'acc': 1.05, 'areas': [SWAMP]},
    {'name': VOODOO_PRIESTESS, 'trait': '', 'hp': 80, 'weapons': [w.VOODOO_STAFF, w.CHILI_POWDER],
