...
Enemies = [
    ...
    {'name': SENTIENT_ROBOT, 'hp': 115, 'weapons': [w.LASER_BEAMS],
     'bounty': 190, 'type': NORMAL, 'flee': 1, 'areas': [CITY]},
    {'name': SLEEPWALKER, 'hp': 95, 'weapons': [w.PILLOW, w.SHOTGUN],
     'bounty': 160, 'type': NORMAL, 'flee': 1, 'areas': [CITY]},
