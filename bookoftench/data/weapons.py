...
Weapons = [
    ...
    {'name': BINOCULARS, 'damage': 11, 'uses': 7, 'accuracy': 0.87, 'var': 2, 'crit': 0.11,
     'cost': 18, 'sell_value': 9, 'type': MELEE, 'subtype': BLUNT, 'tier': 1, 'sound': audio.BLUNT,
     'areas': NA},

    {'name': BROKEN_BOTTLE, 'damage': 14, 'uses': 6, 'accuracy': 0.84, 'var': 4, 'crit': 0.14,
    ...
    {'name': TROWEL, 'damage': 13, 'uses': 11, 'accuracy': 0.88, 'var': 2, 'crit': 0.06,
    ...
    {'name': KNIFE, 'damage': 16, 'uses': 9, 'accuracy': 0.89, 'var': 3, 'crit': 0.12,
    ...
    #                       TIER 3
    # =====================================================
    {'name': AXE, 'damage': 30, 'uses': 7, 'accuracy': 0.74, 'var': 4, 'crit': 0.10,
    ...
    {'name': FIRE_AXE, 'damage': 32, 'uses': 6, 'accuracy': 0.75, 'var': 4, 'crit': 0.09,
    ...
    {'name': MACHETE, 'damage': 26, 'uses': 8, 'accuracy': 0.81, 'var': 3, 'crit': 0.11,
     'cost': 55, 'sell_value': 28, 'type': MELEE, 'subtype': BLADED, 'tier': 3, 'sound': audio.BLADE,
     'areas': [CITY, FOREST, SWAMP]},

    {'name': MEAT_CLEAVER, 'damage': 25, 'uses': 9, 'accuracy': 0.82, 'var': 4, 'crit': 0.13,
     'cost': 38, 'sell_value': 19, 'type': MELEE, 'subtype': BLADED, 'tier': 3, 'sound': audio.BLADE,
     'areas': [CITY, SWAMP]},

    {'name': OBSIDIAN_KNIFE, 'damage': 28, 'uses': 8, 'accuracy': 0.88, 'var': 4, 'crit': 0.19,
    ...
    {'name': SCYTHE, 'damage': 27, 'uses': 9, 'accuracy': 0.77, 'var': 4, 'crit': 0.11,
    ...
    {'name': SURVIVAL_KNIFE, 'damage': 21, 'uses': 10, 'accuracy': 0.86, 'var': 4, 'crit': 0.12,
    ...
    {'name': NAIL_GUN, 'damage': 28, 'uses': 6, 'accuracy': 0.70, 'var': 4, 'crit': 0.14,
     'cost': 70, 'sell_value': 35, 'type': RANGED, 'subtype': RANGED, 'tier': 4, 'sound': audio.ARROW,
     'areas': [CITY]},
    ...
    {'name': REVOLVER, 'damage': 38, 'uses': 6, 'accuracy': 0.70, 'var': 6, 'crit': 0.17,
    ...
    {'name': SLEDGEHAMMER, 'damage': 38, 'uses': 10, 'accuracy': 0.68, 'var': 7, 'crit': 0.08,
