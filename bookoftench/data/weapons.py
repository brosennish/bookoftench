...
Weapons = [
    ...
    {'name': TROWEL, 'damage': 13, 'uses': 13, 'accuracy': 0.88, 'var': 2, 'crit': 0.06,
     'cost': 14, 'sell_value': 7, 'type': MELEE, 'subtype': BLADED, 'tier': 1, 'sound': audio.BLADE,
     'areas': [FOREST, CAVE]},
    ...
    {'name': BRASS_KNUCKLES, 'damage': 21, 'uses': 11, 'accuracy': 0.89, 'var': 3, 'crit': 0.11,
     'cost': 55, 'sell_value': 25, 'type': MELEE, 'subtype': MELEE, 'tier': 2, 'sound': audio.PUNCH,
     'areas': [CITY]},
    ...
    {'name': KNIFE, 'damage': 16, 'uses': 9, 'accuracy': 0.89, 'var': 4, 'crit': 0.12,
     'cost': 24, 'sell_value': 12, 'type': MELEE, 'subtype': BLADED, 'tier': 2, 'sound': audio.BLADE,
     'areas': [CAVE, CITY, FOREST, SWAMP]},
    ...
    {'name': SHIV, 'damage': 18, 'uses': 10, 'accuracy': 0.89, 'var': 3, 'crit': 0.12,
     'cost': 20, 'sell_value': 10, 'type': MELEE, 'subtype': BLADED, 'tier': 2, 'sound': audio.BLADE,
     'areas': NA},
    ...
    {'name': SWITCHBLADE, 'damage': 19, 'uses': 11, 'accuracy': 0.90, 'var': 4, 'crit': 0.13,
     'cost': 28, 'sell_value': 14, 'type': MELEE, 'subtype': BLADED, 'tier': 2, 'sound': audio.BLADE,
     'areas': [CITY]},
    ...
    {'name': GAFF_HOOK, 'damage': 27, 'uses': 8, 'accuracy': 0.80, 'var': 4, 'crit': 0.10,
     'cost': 48, 'sell_value': 24, 'type': MELEE, 'subtype': BLADED, 'tier': 3, 'sound': audio.BLADE,
     'areas': [SWAMP, CITY]},
    ...
    {'name': OBSIDIAN_KNIFE, 'damage': 28, 'uses': 8, 'accuracy': 0.88, 'var': 4, 'crit': 0.16,
     'cost': 58, 'sell_value': 29, 'type': MELEE, 'subtype': BLADED, 'tier': 3, 'sound': audio.BLADE,
     'areas': [CAVE, FOREST]},
    ...
    {'name': KATANA, 'damage': 33, 'uses': 8, 'accuracy': 0.81, 'var': 5, 'crit': 0.15,
     'cost': 88, 'sell_value': 40, 'type': MELEE, 'subtype': MELEE, 'tier': 4, 'sound': audio.BLADE,
     'areas': [CITY]},

    {'name': LONGBOW, 'damage': 26, 'uses': 11, 'accuracy': 0.76, 'var': 3, 'crit': 0.15,
     'cost': 68, 'sell_value': 34, 'type': RANGED, 'subtype': RANGED, 'tier': 4, 'sound': audio.ARROW,
     'areas': [FOREST]},
    ...
    {'name': PISTOL, 'damage': 31, 'uses': 6, 'accuracy': 0.85, 'var': 5, 'crit': 0.11,
     'cost': 70, 'sell_value': 34, 'type': RANGED, 'subtype': RANGED, 'tier': 4, 'sound': audio.PISTOL,
     'areas': [CAVE, CITY, FOREST, SWAMP]},

    {'name': REVOLVER, 'damage': 38, 'uses': 5, 'accuracy': 0.70, 'var': 5, 'crit': 0.10,
     'cost': 78, 'sell_value': 39, 'type': RANGED, 'subtype': RANGED, 'tier': 4, 'sound': audio.PISTOL,
     'areas': [CAVE, CITY, FOREST, SWAMP]},

    {'name': RIFLE, 'damage': 36, 'uses': 6, 'accuracy': 0.86, 'var': 5, 'crit': 0.12,
     'cost': 88, 'sell_value': 41, 'type': RANGED, 'subtype': RANGED, 'tier': 4, 'sound': audio.RIFLE,
     'areas': [CAVE, CITY, FOREST, SWAMP]},
    ...
    {'name': SLINGSHOT, 'damage': 17, 'uses': 14, 'accuracy': 0.84, 'var': 2, 'crit': 0.12,
     'cost': 27, 'sell_value': 14, 'type': RANGED, 'subtype': RANGED, 'tier': 4, 'sound': audio.ARROW,
     'areas': [CITY, FOREST, SWAMP]},
    ...
    {'name': CHAINSAW, 'damage': 40, 'uses': 6, 'accuracy': 0.71, 'var': 6, 'crit': 0.10,
     'cost': 95, 'sell_value': 47, 'type': MELEE, 'subtype': MELEE, 'tier': 5, 'sound': audio.CHAINSAW,
     'areas': [CITY, FOREST, SWAMP]},
    ...
    #                       SPECIAL
    # =====================================================
    {'name': TENCH_CANNON, 'damage': 99, 'uses': 1, 'accuracy': 0.22, 'var': 1, 'crit': 0.10,
     'cost': 100, 'sell_value': 25, 'type': RANGED, 'subtype': RANGED, 'tier': 5, 'sound': audio.SHOTGUN,
     'areas': [CITY]},
