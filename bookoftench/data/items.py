...
Items = [
    ...
    {'name': ACCURACY_SEARUM, 'type': STAT, 'hp': 0, 'cost': 110, 'sell_value': 35, 'areas': [CAVE, FOREST],
     'desc': 'Increase accuracy by 0.03', 'sound': ''},
    {'name': BOOMERANG, 'type': ENEMY, 'hp': 0, 'cost': 45, 'sell_value': 0, 'areas': [CITY, FOREST, SWAMP],
     'desc': 'Do X damage to enemy and lose X HP', 'sound': ''},
    {'name': CRITICAL_BASS, 'type': CRIT, 'hp': 0, 'cost': 55, 'sell_value': 18, 'areas': [CAVE, FOREST],
     'desc': 'Make your next attack a critical hit', 'sound': ''},
    {'name': FLACCID_ACID, 'type': ENEMY, 'hp': 0, 'cost': 75, 'sell_value': 22, 'areas': [CAVE, CITY, SWAMP],
     'desc': 'Lower enemy strength by 25%', 'sound': ''},
    {'name': HTH, 'type': STAT, 'hp': 0, 'cost': 110, 'sell_value': 35, 'areas': [CITY, SWAMP],
     'desc': 'Increase strength by 0.03', 'sound': ''},
    {'name': IOU, 'type': FLEE, 'hp': 0, 'cost': 10, 'sell_value': 3, 'areas': [CITY],
     'desc': 'Use to escape from battle', 'sound': ''},
    {'name': MOON_RUNE, 'type': ENEMY, 'hp': 0, 'cost': 80, 'sell_value': 24, 'areas': [CAVE, FOREST],
     'desc': 'Do damage to enemy based on the Moon (requires moonlight)', 'sound': ''},
    {'name': PHOTOSYNTHOPHYL, 'type': HEALTH, 'hp': 0, 'cost': 110, 'sell_value': 30, 'areas': [FOREST, SWAMP],
     'desc': 'Fully restore HP (requires sunlight)', 'sound': ''},
    {'name': SMOKE_BOMB, 'type': FLEE, 'hp': 0, 'cost': 20, 'sell_value': 7, 'areas': [CAVE, CITY, FOREST, SWAMP],
     'desc': 'Use to escape from battle', 'sound': ''},
    {'name': TENCHTOSTERONE, 'type': DMG, 'hp': 0, 'cost': 95, 'sell_value': 30, 'areas': [CITY, SWAMP],
     'desc': 'Double the damage of your next melee attack', 'sound': ''},
    ...
    {'name': nPnG, 'type': HEALTH, 'hp': 0, 'cost': 105, 'sell_value': 28, 'areas': [CAVE, CITY],
     'desc': 'Lose X HP and increase max HP by X', 'sound': ''},
]
