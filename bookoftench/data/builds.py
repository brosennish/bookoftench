...
Builds = [
    ...
    {'name': MERCENARY, 'lives': 3, 'hp': 110, 'str': 1.05, 'acc': 1.05, 'coins': 20,
     'items': [CANNED_HORSE],
    ...
    {'name': SHOPAHOLIC, 'lives': 3, 'hp': 95, 'str': 0.90, 'acc': 0.90, 'coins': 300,
     'items': [IOU],
    ...
    {'name': TENCH, 'lives': 4, 'hp': 110, 'str': 1.10, 'acc': 0.70, 'coins': 0,
     'items': [KRILL, CRAY],
    ...
    {'name': BRO, 'lives': 3, 'hp': 100, 'str': 1, 'acc': 1, 'coins': 50,
