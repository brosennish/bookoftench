...
from bookoftench.data.items import TENCH_FILET, IOU, SMOKE_BOMB, WORMHOLE, CRAY, KRILL, CANNED_HORSE, \
    OCEAN_MAN_LUNCH_BOX, EAGLE_EGG, MYSTERY_MEAT, TENCHTOSTERONE, CRITICAL_BASS
...
Builds = [
    {'name': DENNY, 'lives': 3, 'hp': 100, 'str': 1, 'acc': 1, 'coins': 25,
     'items': [TENCH_FILET],
    ...
    {'name': COWARD, 'lives': 3, 'hp': 90, 'str': 0.9, 'acc': 0.9, 'coins': 10,
    ...
    {'name': MERCENARY, 'lives': 3, 'hp': 100, 'str': 1.05, 'acc': 1.05, 'coins': 20,
     'items': [CANNED_HORSE],
    ...
    {'name': SHOPAHOLIC, 'lives': 3, 'hp': 95, 'str': 0.85, 'acc': 0.85, 'coins': 200,
     'items': [IOU],
    ...
    {'name': TENCH, 'lives': 4, 'hp': 111, 'str': 1.11, 'acc': 0.77, 'coins': 0,
     'items': [KRILL, CRAY],
