...
from bookoftench.audio import restart_music, stop_all_sounds
from bookoftench.data.components import SETTINGS
from bookoftench.model import GameState
from bookoftench.ui import yellow
from bookoftench.util import safe_input, print_and_sleep
